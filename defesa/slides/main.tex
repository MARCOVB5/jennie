...
\begin{center}
\includegraphics[width=0.4\textwidth]{img/case.png}
\end{center}
...
\begin{itemize}
    \item Conexão entre redes diferentes bem sucedida.
    ...
    \item Possível levantar diversos serviços.
...
\begin{frame}
\frametitle{Fastfetch}

\begin{center}
\includegraphics[width=\textwidth]{img/fastfetch.png}
\end{center}
...
\begin{verbatim}
localhost ~ # vcgencmd pmic_read_adc 
...
  VDD_CORE_A current(7)=0.51794000A 
...
  VDD_CORE_V volt(15)=0.75052430V 
...
     EXT5V_V volt(24)=4.94058000V 
...
localhost ~ # vcgencmd get_throttled 
throttled=0x0 
localhost ~ # 
\end{verbatim}
\end{frame}
