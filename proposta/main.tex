...
\begin{figure}[H]  
    ...
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{diagrama.jpg}}
...
\begin{itemize}
    \item \textbf{RF01 - Gerenciamento de Armazenamento:} O sistema deve ser capaz de reconhecer, formatar e gerenciar um arranjo de até 4 discos rígidos de forma eficiente.
